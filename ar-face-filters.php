...
<html lang="en-US">
   <head>
      ...
      <link rel="canonical" href="https://experientialetc.com/ar-face-filters" />
   </head>
   <body>
      		    ...
      		    <div class="cus-services text-center">
      		        ...
      		        <div class="row">
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar/holi face.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar/mask filter.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar/santa hat.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar/tiger.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar/turban.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar/matki.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar/kathakali face.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar/dhunachi head.mp4">
          		                 </video>
      		                </div>
      		            </div>

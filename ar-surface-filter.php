...
<html lang="en-US">
   <head>
      ...
      <link rel="canonical" href="https://experientialetc.com/ar-surface-filters" />
   </head>
   <body>
      		    ...
      		    <div class="cus-services text-center">
      		        ...
      		        <div class="row">
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar-surface-filter/crackers 1.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar-surface-filter/crackers 2.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar-surface-filter/holi surface.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar-surface-filter/holy feet.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar-surface-filter/kathakali surface.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar-surface-filter/laxmi maa.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar-surface-filter/mahabali.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar-surface-filter/pookalam.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar-surface-filter/pulikali.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar-surface-filter/real estate.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar-surface-filter/rocket.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/ar-surface-filter/santa dance.mp4">
          		                 </video>
      		                </div>
      		            </div>

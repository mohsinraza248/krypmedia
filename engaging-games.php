...
<html lang="en-US">
   <head>
      ...
      <link rel="canonical" href="https://experientialetc.com/engaging-games" />
   </head>
   <body>
      		    ...
      		    <div class="cus-services text-center">
      		        ...
      		        <div class="row">
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/games/hide and seek.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/games/light my world.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/games/navratri challenge.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/games/puzzle.mp4">
          		                 </video>
      		                </div>
      		            </div>

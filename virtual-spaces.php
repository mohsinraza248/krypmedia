...
<html lang="en-US">
   <head>
      ...
      <link rel="canonical" href="https://experientialetc.com/virtual-spaces" />
   </head>
   <body>
      		    ...
      		    <div class="cus-services text-center">
      		        ...
      		        <div class="row">
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/virtual-spaces/imperial.mp4">
          		                 </video>
      		                </div>
      		            </div>
      		            ...
      		            <div class="col-lg-4 col-6 mb-4">
      		                <div class="service-tile-2">
          		                 <video autoplay muted loop playsinline class="w-100">
          		                     <source src="./videos/virtual-spaces/mi virtual store.mp4">
          		                 </video>
      		                </div>
      		            </div>

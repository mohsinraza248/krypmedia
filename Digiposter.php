...
<html lang="en-US">
   <head>
      ...
      <link rel="canonical" href="https://experientialetc.com/Digiposter" />
   </head>
   <body>
      <?php include ('includes/navigation.php') ; ?>
      <div class="videobg">
		<div id="video_overlays"><h1>Digiposter</h1><br>
		...
		<video  width="100%" class="video-h"  autoplay="" muted="" loop="" id="holomistVideo" class="scrollhidex">
            <source src="videos/Digiposter.mp4" type="video/mp4">
        </video>
      </div>
      <div class="main">
      	<div class="about-us">
      		<div class="container">
      			<div class="row">
      				<div class="col-sm-9">
      					<div class="title">
      						<h1>Digiposter</h1><br>
							<p>The magic unveils as the pixel pitch get smaller to  reveal a seamless and slim layer of digital content .  Bright, stunning and customizable. This little gem is here to stay.</p><br>
